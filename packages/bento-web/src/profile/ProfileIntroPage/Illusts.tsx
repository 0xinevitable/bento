...
export const Illusts: React.FC = () => (
  <IllustContainer>
    ...
    <UniswapBadgeContainer>
      <UniswapBadge alt="Received the 2020 UNI Airdrop" />
    </UniswapBadgeContainer>
    <OsmosisBadgeContainer>
      <OsmosisBadge alt="Voted on Proposal #322" />
    </OsmosisBadgeContainer>
    ...
    <RightStickerWrapper>
      <RightStickerContainer>
        <DefineYourselfStickerContainer>
          <DefineYourselfSticker alt="DEFINE YOURSELF" />
        </DefineYourselfStickerContainer>
        <BuidlStickerTopContainer>
          <BuidlStickerTop alt="BUIDL" />
        </BuidlStickerTopContainer>
        <BuidlStickerBottomContainer>
          <BuidlStickerBottom alt="" />
        </BuidlStickerBottomContainer>
